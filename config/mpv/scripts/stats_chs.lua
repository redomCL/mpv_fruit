...
input.conf 示例：
 ...
 <KEY>   script-binding stats_chs/display-stats          # 临时显示统计信息
 <KEY>   script-binding stats_chs/display-stats-toggle   # 常驻显示统计信息
 <KEY>   script-binding stats_chs/display-page-1         # 显示第一页的信息（亦可在显示时按12340跳转至对应页面）
 <KEY>   script-binding stats_chs/display-page-2         # ...
 <KEY>   script-binding stats_chs/display-page-3         # ...
 <KEY>   script-binding stats_chs/display-page-4         # ...
 <KEY>   script-binding stats_chs/display-page-0         # ...

 <KEY>   script-message-to stats_chs display-stats          # 同上
 <KEY>   script-message-to stats_chs display-stats-toggle   # ...
 <KEY>   script-message-to stats_chs display-page-1         # ...
 <KEY>   script-message-to stats_chs display-page-2         # ...
 <KEY>   script-message-to stats_chs display-page-3         # ...
 <KEY>   script-message-to stats_chs display-page-4         # ...
 <KEY>   script-message-to stats_chs display-page-0         # ...
