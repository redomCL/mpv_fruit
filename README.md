...
* 0.基于mpv player、mpv_lazy、dyphire/mpv-config重新组装，仅专注本地PC/HTPC高质量播放(PC/HTPC是不同的高质量情景)，对于PC场景，默认预设了全为前方的多声道，如果用户没有设备，则会自动转到普通立体声模式。对于HTPC，默认预设了常规的7.1、5.1、4.0以及立体声。
