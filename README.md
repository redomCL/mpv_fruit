...
|3|全精度|CPU|新渲染器，缩放算法：deband=yes,cscale=ewa_lanczos,scale=ewa_lanczos,sigmoid-upscaling=yes,dscale=lanczos,correct-downscaling=yes|误差抖动(内核为floyd-steinberg)|2(高，支持HDR)|
